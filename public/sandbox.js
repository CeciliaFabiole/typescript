...
//da filter
console.log(filter.filter(filter.arr, filter.getLessThan3));
console.log(filter.filter(filter.arr, filter.get3));
console.log(filter.filter(filter.arrString, filter.getA));
